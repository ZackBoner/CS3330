...
function_info functions[] = {
    ...
    // ADD ENTRIES HERE!
    {sum_unrolled2, "sum_unrolled2: unrolls loop to handle two elements per iteration"},
    {sum_unrolled4, "sum_unrolled4: unrolls loop to handle four elements per iteration"},
    {sum_multiple_accum, "sum_multiple_accum: 4 way unroll and 4 accumulators"},
